<template>
  <div class="items">
    <div v-for="item in list" class="items-item" v-show="haveData">
      ...
      <div class="item">
        ...
        <div class="center">:</div>
        <div class="right">{{item.workTime}}</div>
      </div>
      <div class="item">
        <div class="left">
          <span>受</span>
        ...
        <div class="center">:</div>
        <div class="right" style="line-height: 1.5em">{{item.scope}}</div>
      </div>
    </div>
...
export default {
  ...
  created() {
    ...
    addLog({
      ...
      subColumnTypeCode: `bsfw_fuwudaohang`
    });
  },
  methods: {
    loadMore() {
